            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-neutral-600 dark:text-neutral-400">
                    Category: {habit.category} • {habit.frequency} • {habit.xpOnComplete} XP
                    {habit.bestStreak && (
                      <span className="block mt-1">Best streak: {habit.bestStreak} {habit.bestStreak === 1 ? 'day' : 'days'}</span>
                    )}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-neutral-600 dark:text-neutral-400">
                    All completion history, progress data, streak records, and earned XP points will be permanently removed.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-neutral-600 dark:text-neutral-400">
                    This action cannot be undone. Consider editing the habit instead to preserve your progress.
                  </p>
                </div>
              </div>
            </div>
